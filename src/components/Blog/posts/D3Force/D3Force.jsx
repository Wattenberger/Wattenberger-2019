...
import { uniqueId, isFinite, times } from "lodash"
...
const D3Force = () => {
  ...
  return (
    <div className="D3Force">
      ...
      <div className={`D3Force__controls D3Force__controls--is-${areControlsVisible ? "visible" : "hidden"}`}>
      ...
      <div className="D3Force__example">
        <D3ForceExample {...{forces, isRunning, tickIteration}} />
      </div>
      ...
      <div className="D3Force__content">
        ...
        >
          ...
          <p>
            The particles are moved according to a set of <strong>forces</strong>.
          </p>
        ...
        <InView padding="40vh" onChange={isInView => {
          ...
          <section>
            ...
            <p>Add a new <strong>x force</strong> (on the right) to our active forces, and move the slider to change the targeted x position.</p>
  ...
  .force("x", d3.forceX(${getForceAttribute("x", "x")}))`}
        ...
        <InView padding="40vh" onChange={isInView => {
          ...
          <section>
            ...
            <p>Try adding a <strong>y force</strong> and moving it around.</p>


            <Code size="m" hasLineNumbers={false}>
{`d3.forceSimulation()
  .force("x", d3.forceY(${getForceAttribute("y", "y")}))`}
            </Code>
          </section>
        </InView>
        <InView padding="40vh" onChange={isInView => {
...
{`d3.forceSimulation()
  ...
  .force("collide", d3.forceCollide(${getForceAttribute("collide", "radius")}).iterations(${getForceAttribute("collide", "iterations")}))`}
        ...
        <InView padding="40vh" onChange={isInView => {
          ...
          <section>
            <h2>The radial force</h2>

            <p>The <strong>radial force</strong> </p>
          </section>
        </InView>
        ...
        <InView padding="40vh" onChange={isInView => {
          ...
          <section>
            <h2>The many body force</h2>

            <p>The <strong>many body force</strong> </p>
          </section>
        </InView>

        {/* <InView padding="40vh" onChange={isInView => {
          if (!isInView) return
          setOptionNames([ "x", "y", "collide", "radial", "many body", "link" ])
          setExcludedMethods([])
          setAreControlsVisible(true)
          setIsRunning(true)
          onSetForces([
          ...
          <section>
            <h2>The link force</h2>

            <p>The <strong>link force</strong> </p>
          </section>
        </InView> */}
        ...
        <InView padding="40vh" onChange={isInView => {
          ...
          <section>
            <h2>The center force</h2>

            <p>The <strong>center force</strong> </p>
          </section>
        </InView>

        <InView padding="40vh" onChange={isInView => {
          if (!isInView) return
          setOptionNames([ "x", "y", "collide", "radial", "many body", "link", "center", "rect collide" ])
          setExcludedMethods([])
          setAreControlsVisible(true)
          setIsRunning(true)
          onSetForces([
            forceTypesMap["rect collide"]
          ])
        }}>
          <section>
            <h2>Custom forces</h2>

            <p>The <strong>rect collide force</strong> </p>
          </section>
        </InView>
